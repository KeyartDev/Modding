...
public class SomePedistalBlockMenu extends AbstractContainerMenu {
    ...
    public SomePedistalBlockMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public SomePedistalBlockMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.SOME_PEDISTAL_BLOCK_MENU.get(), pContainerId);
        checkContainerSize(inv, 2);
        blockEntity = ((SomeBlockPedistalBlockEntity) entity);
